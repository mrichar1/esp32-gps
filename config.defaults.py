...
# NTRIP configuration
# Common config
NTRIP_MODE = "client"               # To enable NTRIP services, set to one of: client (pull NTRIP data from caster), server (upload NTRIP data to a caster), caster (offer NTRIP data to clients) or caster+server.
